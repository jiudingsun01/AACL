...
if __name__ == "__main__":
  # Flan-T5-3B Alpaca-7B Vicuna-7B T0++ 11B Flan-T5-11B WizardLM-13B
    ...
    # model_name = "ziqingyang/chinese-alpaca-1-7b"
    ...
    # QA:
    # 1. Origin
    # 1. You are given a multi-choice question answering task, given the question and mutliple answer options, select the option that can be reasonably derived from the sentence's context and content.
    ...
    # RE:
    # 1. Origin
    # 1. Involving a given sentence and two entities within it, your goal is to identify the relationship between the two entities using the provided sentence. Choose from the set of relationships provided below.
    ...
    #     with open('./vicuna-7b-v1.5/result.txt', 'a') as file:

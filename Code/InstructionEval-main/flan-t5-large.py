...
if __name__ == "__main__":
    ...
    # 4. The challenge is to establish the relationship between two entities within a given sentence. Your task is to classify this relationship larged on the sentence provided. Explore the list of possible relationships below.
